  ...
  <div>
    <div class="dashboard-content-one">
      ...
      <div class="breadcrumbs-area">
        ...
        <ul>
          <li>
            <nuxt-link to="/dashboard/admin/student/all">All Students</nuxt-link>
          </li>
      ...
      <div class="card height-auto" ref="printArea">
        <div class="card-body">
          ...
          <div class="single-info-details">
            <div class="item-img">
              <img :src="student.image" alt="dp" v-if="student.image" width="280" height="330" />
              ...
              <div class="info-table table-responsive">
                <table class="table text-nowrap">
                  <tbody>
                    ...
                    <tr>
                      <td>Blood Group:</td>
                      <td class="font-medium text-dark-medium">{{student.bloodGroup}}</td>
                    </tr>
                    <tr>
