                ...
                <form class="new-added-form">
                  <div class="row">
                    ...
                    <div class="col-12-xxxl col-lg-6 col-12 form-group">
                      ...
                      <input type="text" class="form-control" :placeholder="user.staffID" disabled />
          ...
          <div class="col-8-xxxl col-12">
            <div class="card height-auto">
              <div class="card-body">
                ...
                <div class="notice-board-wrap" v-if="user.profile.recieved">
                  <div
                    class="notice-list"
                    v-for="message in user.profile.recieved"
                    :key="message._id"
                  >
                    <div
...
export default {
  ...
  methods: {
    submit() {
      this.$emit("onSubmit", this.newMessage);
    },
    toggleBody(id) {
      // console.log(id);
