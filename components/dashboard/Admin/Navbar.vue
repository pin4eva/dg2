      ...
      <div class="navbar navbar-expand-md header-menu-one bg-light">
        <div class="nav-bar-header-one">
          <div class="header-logo">
            <nuxt-link :to="pageHome">
              <img src="/main.png" alt="logo" width="70" />
            </nuxt-link>
          </div>
                ...
                <div class="item-content">
                  <div class="media">
                    <div class="item-img bg-skyblue author-online">
                      <img src="/dashboard/img/figure/student11.png" alt="img" />
                    </div>
                  ...
                  <div class="media">
                    <div class="item-img bg-yellow author-online">
                      <img src="/dashboard/img/figure/student12.png" alt="img" />
                    </div>
                    <div class="media-body space-sm">
                      <div class="item-title">
                        <a href="#">
                  ...
                  <div class="media">
                    <div class="item-img bg-pink">
                      <img src="/dashboard/img/figure/student13.png" alt="img" />
                    </div>
                    <div class="media-body space-sm">
                      <div class="item-title">
                        <a href="#">
